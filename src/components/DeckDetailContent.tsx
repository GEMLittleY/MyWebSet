      ...
      <div className="card p-3 sm:p-4 mb-6 sm:mb-8">
        <div className="flex items-center justify-between gap-3 flex-wrap">
          ...
          <div className="flex gap-2 shrink-0 relative flex-wrap">
            ...
            <Link
              href={localePath(`/coach?deck=${deck.slug}`)}
              className="px-3 sm:px-4 py-2 rounded-lg bg-[#1a1f2e] border border-[#2a3040] text-gray-300 text-xs sm:text-sm font-medium hover:border-[#c084fc] hover:text-[#c084fc] transition-colors whitespace-nowrap inline-flex items-center gap-1.5"
            >
              <svg
